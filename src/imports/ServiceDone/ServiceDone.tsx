import svgPaths from "./svg-fjltev2wfd";
import { imgVector } from "./svg-412at";
...
function Icon() {
  return (
    <div className="absolute left-[67px] size-[119px] top-[104px]" data-name="Icon">
...
function Paragraph() {
  return (
    <div className="absolute h-[16px] left-[205px] top-[164px] w-[1191px]" data-name="Paragraph">
...
function Group1() {
  return (
    <div className="absolute contents left-[67px] top-[104px]">
      <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[16px] left-[203px] not-italic text-[32px] text-black top-[129px] tracking-[2.56px] whitespace-nowrap">Danh mục dịch vụ cứu hộ của ResQ</p>
      <Icon />
      <Paragraph />
    </div>
  );
...
function Group() {
  return (
    <div className="absolute contents inset-[-0.02%_-0.02%_-0.01%_0]" data-name="Group">
      ...
      <div className="absolute inset-[63.32%_-0.02%_-0.01%_62.84%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-27.65px_-31.024px] mask-size-[44px_49px]" data-name="Vector" style={{ maskImage: `url('${imgVector}')` }}>
  ...
  return (
    <div className="relative shrink-0 size-[36px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36 36">
        <g id="Icon">
          <path d="M30 9L13.5 25.5L6 18" id="Vector" stroke="var(--stroke-0, #EE3224)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.75" />
        </g>
      </svg>
    </div>
  );
...
function Container51() {
  return (
    <div className="absolute bg-[rgba(238,50,36,0.08)] content-stretch flex items-center justify-center left-[224px] px-[18px] rounded-[36px] size-[72px] top-[32px]" data-name="Container">
      <Icon15 />
    </div>
  );
}
...
function Paragraph55() {
  return (
    <div className="absolute h-[27px] left-[32px] top-[124px] w-[456px]" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[27px] left-[228px] not-italic text-[#080b0d] text-[18px] text-center top-[-0.5px] whitespace-nowrap">Yêu cầu đã được gửi!</p>
    </div>
  );
}
...
function Paragraph56() {
  return (
    <div className="absolute h-[20px] left-[32px] top-[157px] w-[456px]" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[20px] left-[228.9px] not-italic text-[#a4a4a4] text-[13px] text-center top-[-0.5px] whitespace-nowrap">Fixer đang được điều phối đến vị trí của bạn</p>
    </div>
  );
}
...
function Text26() {
  return (
    <div className="h-[18px] relative shrink-0 w-[50.406px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[18px] left-0 not-italic text-[#a4a4a4] text-[12px] top-0 whitespace-nowrap">Dịch vụ</p>
      </div>
    </div>
  );
}
...
function Text27() {
  return (
    <div className="h-[18px] relative shrink-0 w-[122.406px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[18px] left-0 not-italic text-[#080b0d] text-[12px] top-0 whitespace-nowrap">Vá lốp / Thay lốp</p>
      </div>
    </div>
  );
}
...
function Text28() {
  return (
    <div className="h-[18px] relative shrink-0 w-[14.406px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[18px] left-0 not-italic text-[#a4a4a4] text-[12px] top-0 whitespace-nowrap">Xe</p>
      </div>
    </div>
  );
}
...
function Text29() {
  return (
    <div className="h-[18px] relative shrink-0 w-[100.805px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[18px] left-0 not-italic text-[#080b0d] text-[12px] top-0 whitespace-nowrap">Honda Wave RSX</p>
      </div>
    </div>
  );
}
...
function Text30() {
  return (
    <div className="h-[18px] relative shrink-0 w-[50.406px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[18px] left-0 not-italic text-[#a4a4a4] text-[12px] top-0 whitespace-nowrap">Biển số</p>
      </div>
    </div>
  );
}
...
function Text31() {
  return (
    <div className="h-[18px] relative shrink-0 w-[72px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[18px] left-0 not-italic text-[#080b0d] text-[12px] top-0 whitespace-nowrap">59F1-12345</p>
      </div>
    </div>
  );
}
...
function Text32() {
  return (
    <div className="h-[18px] relative shrink-0 w-[86.406px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[18px] left-0 not-italic text-[#a4a4a4] text-[12px] top-0 whitespace-nowrap">Giá ước tính</p>
      </div>
    </div>
  );
}
...
function Text33() {
  return (
    <div className="h-[18px] relative shrink-0 w-[72px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[18px] left-0 not-italic text-[#ee3224] text-[12px] top-0 whitespace-nowrap">Từ 50.000đ</p>
      </div>
    </div>
  );
}
...
function Text34() {
  return (
    <div className="h-[18px] relative shrink-0 w-[72px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[18px] left-0 not-italic text-[#a4a4a4] text-[12px] top-0 whitespace-nowrap">Mã yêu cầu</p>
      </div>
    </div>
  );
}
...
function Text35() {
  return (
    <div className="h-[18px] relative shrink-0 w-[72.008px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[18px] left-0 not-italic text-[#080b0d] text-[12px] top-0 whitespace-nowrap">RSQ-330993</p>
      </div>
    </div>
  );
}
...
function Container52() {
  return (
    <div className="absolute bg-[#fafafa] content-stretch flex flex-col gap-[8px] h-[154px] items-start left-[32px] pt-[16px] px-[16px] rounded-[10px] top-[185px] w-[456px]" data-name="Container">
      <Container53 />
      <Container54 />
      <Container55 />
      <Container56 />
...
function Button3() {
  return (
    <div className="bg-white flex-[149.336_0_0] h-[50px] min-h-px min-w-px relative rounded-[10px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center p-px relative size-full">
        <p className="font-['IBM_Plex_Mono:Medium',sans-serif] leading-[19.5px] not-italic relative shrink-0 text-[#080b0d] text-[13px] text-center whitespace-nowrap">Đóng</p>
      </div>
    </div>
  );
}
...
function Icon16() {
  return (
    <div className="absolute left-[209.97px] size-[16px] top-[17px]" data-name="Icon">
...
function Button4() {
  return (
    <div className="bg-[#ee3224] flex-[294.664_0_0] h-[50px] min-h-px min-w-px relative rounded-[10px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[21px] left-[136.19px] not-italic text-[14px] text-center text-white top-[13.5px] tracking-[1.12px] whitespace-nowrap">Theo dõi Fixer</p>
        <Icon16 />
      </div>
    </div>
  );
...
function Container58() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[50px] items-start left-[32px] top-[363px] w-[456px]" data-name="Container">
      <Button3 />
      <Button4 />
    </div>
  );
...
function Container50() {
  return (
    <div className="bg-white h-[445px] relative rounded-[16px] shrink-0 w-[520px]" data-name="Container">
...
export default function ServiceDone() {
  return (
    <div className="bg-white relative size-full" data-name="service ( done)">
      <Body />
      <ServiceModal />
    </div>
  );
