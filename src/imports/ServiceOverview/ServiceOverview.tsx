import svgPaths from "./svg-7983tidw47";
import { imgVector } from "./svg-u6q0j";

function Container() {
  return <div className="absolute h-[119px] left-[84px] top-[62px] w-[1191px]" data-name="Container" />;
}
...
function Body() {
  return (
    <div className="absolute h-[997px] left-0 overflow-clip top-0 w-[1359px]" data-name="Body">
      <Layout />
    </div>
  );
}
...
function Icon14() {
  return (
    <div className="absolute h-[119px] left-[80px] top-[151px] w-[129.029px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 129.029 119">
        <g id="Icon">
          <path d={svgPaths.pba7d480} id="Vector" stroke="var(--stroke-0, #EE3224)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.pc499760} id="Vector_2" stroke="var(--stroke-0, #EE3224)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Paragraph54() {
  return (
    <div className="absolute h-[16px] left-[229.63px] top-[211px] w-[1291.37px]" data-name="Paragraph">
...
function Group1() {
  return (
    <div className="absolute contents left-[80px] top-[151px]">
      <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[16px] left-[227.46px] not-italic text-[32px] text-black top-[176px] tracking-[2.56px] w-[752.486px]">Danh mục dịch vụ cứu hộ của ResQ</p>
      <Icon14 />
      <Paragraph54 />
    </div>
  );
...
function SvgIconLarge() {
  return (
    <div className="bg-[rgba(238,50,36,0.08)] relative rounded-[14px] shrink-0 size-[64px]" data-name="SvgIconLarge">
...
function Paragraph55() {
  return (
    <div className="h-[26px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[26px] left-0 not-italic text-[#080b0d] text-[18px] top-[-1px] whitespace-nowrap">Vá lốp / Thay lốp</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[13px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 13">
        <g clipPath="url(#clip0_1_8874)" id="Icon">
          <path d={svgPaths.p1d11280} id="Vector" stroke="var(--stroke-0, #A4A4A4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.08333" />
          <path d={svgPaths.p2fb53000} id="Vector_2" stroke="var(--stroke-0, #A4A4A4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.08333" />
        </g>
        <defs>
          <clipPath id="clip0_1_8874">
...
function Text26() {
  return (
    <div className="h-[18px] relative shrink-0 w-[108px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[18px] left-0 not-italic text-[#a4a4a4] text-[12px] top-0 whitespace-nowrap">ETA: 15-25 phút</p>
      </div>
    </div>
  );
}
...
function Container53() {
  return (
    <div className="h-[64px] relative shrink-0 w-[263.602px]" data-name="Container">
...
function Container52() {
  return (
    <div className="absolute content-stretch flex h-[64px] items-start justify-between left-[24px] top-[24px] w-[472px]" data-name="Container">
      <Container53 />
      <Button3 />
    </div>
  );
...
function Paragraph56() {
  return (
    <div className="absolute h-[21px] left-[24px] top-[112px] w-[472px]" data-name="Paragraph">
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[21px] left-0 not-italic text-[#4a5565] text-[13px] top-0 whitespace-nowrap">Xử lý nhanh lốp xe bị thủng, xẹp hoặc hư hỏng trên đường.</p>
    </div>
  );
}
...
function Paragraph57() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[16.5px] left-0 not-italic text-[#a4a4a4] text-[11px] top-0 tracking-[0.5px] whitespace-nowrap">DỊCH VỤ BAO GỒM</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[11px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 11">
        <g id="Icon">
          <path d={svgPaths.p3fc33700} id="Vector" stroke="var(--stroke-0, #EE3224)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.14583" />
        </g>
      </svg>
    </div>
  );
...
function Container59() {
  return (
    <div className="bg-[rgba(238,50,36,0.1)] relative rounded-[10px] shrink-0 size-[20px]" data-name="Container">
...
function Text27() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-[179.406px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[19.5px] left-0 not-italic text-[#080b0d] text-[13px] top-[-1px] whitespace-nowrap">Kiểm tra tình trạng lốp</p>
      </div>
    </div>
  );
}
...
function Text28() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-[156px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[19.5px] left-0 not-italic text-[#080b0d] text-[13px] top-[-1px] whitespace-nowrap">Vá hoặc thay lốp mới</p>
      </div>
    </div>
  );
}
...
function Text29() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-[156px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[19.5px] left-0 not-italic text-[#080b0d] text-[13px] top-[-1px] whitespace-nowrap">Bơm hơi đúng áp suất</p>
      </div>
    </div>
  );
}
...
function Container56() {
  return (
    <div className="absolute bg-[#fafafa] content-stretch flex flex-col gap-[10px] h-[134.5px] items-start left-[24px] pt-[16px] px-[16px] rounded-[10px] top-[153px] w-[472px]" data-name="Container">
      <Paragraph57 />
      <Container57 />
    </div>
  );
...
function Paragraph58() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[16.5px] left-0 not-italic text-[#a4a4a4] text-[11px] top-0 tracking-[0.5px] whitespace-nowrap">CHỌN XE</p>
    </div>
  );
}
...
function Icon21() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Icon">
          <path d={svgPaths.p2d6e4900} id="Vector" stroke="var(--stroke-0, #EE3224)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p16c72200} id="Vector_2" stroke="var(--stroke-0, #EE3224)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p1b2576f0} id="Vector_3" stroke="var(--stroke-0, #EE3224)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.pdbb80c0} id="Vector_4" stroke="var(--stroke-0, #EE3224)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Container66() {
  return (
    <div className="bg-[rgba(238,50,36,0.1)] relative rounded-[10px] shrink-0 size-[40px]" data-name="Container">
...
function Paragraph59() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[19.5px] left-0 not-italic text-[#080b0d] text-[13px] top-[-1px] whitespace-nowrap">Honda Wave RSX</p>
    </div>
  );
}
...
function Paragraph60() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[16.5px] left-0 not-italic text-[#a4a4a4] text-[11px] top-0 whitespace-nowrap">59F1-12345 · Xe máy</p>
    </div>
  );
}
...
function Container67() {
  return (
    <div className="flex-[350_0_0] h-[36px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Paragraph59 />
        <Paragraph60 />
      </div>
  ...
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="Icon">
          <path d="M10 3L4.5 8.5L2 6" id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
        </g>
      </svg>
    </div>
  );
...
function Container68() {
  return (
    <div className="bg-[#ee3224] relative rounded-[11px] shrink-0 size-[22px]" data-name="Container">
...
function Button4() {
  return (
    <div className="bg-[rgba(238,50,36,0.02)] h-[68px] relative rounded-[10px] shrink-0 w-full" data-name="Button">
...
function Icon23() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Icon">
          <path d={svgPaths.p1bf46290} id="Vector" stroke="var(--stroke-0, #A4A4A4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p3eeb1e00} id="Vector_2" stroke="var(--stroke-0, #A4A4A4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M6.75 12.75H11.25" id="Vector_3" stroke="var(--stroke-0, #A4A4A4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p3ca81400} id="Vector_4" stroke="var(--stroke-0, #A4A4A4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Container69() {
  return (
    <div className="bg-[#f3f3f5] relative rounded-[10px] shrink-0 size-[40px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[11px] relative size-full">
        <Icon23 />
      </div>
    </div>
...
function Paragraph61() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[19.5px] left-0 not-italic text-[#080b0d] text-[13px] top-[-1px] whitespace-nowrap">Toyota Vios</p>
    </div>
  );
}
...
function Paragraph62() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[16.5px] left-0 not-italic text-[#a4a4a4] text-[11px] top-0 whitespace-nowrap">51G-67890 · Ô tô</p>
    </div>
  );
}
...
function Container70() {
  return (
    <div className="flex-[386_0_0] h-[36px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <Paragraph61 />
        <Paragraph62 />
      </div>
...
function Container64() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] h-[168.5px] items-start left-[24px] top-[307.5px] w-[472px]" data-name="Container">
      <Paragraph58 />
      <Container65 />
    </div>
  );
...
function Paragraph63() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[16.5px] left-0 not-italic text-[#a4a4a4] text-[11px] top-0 tracking-[0.5px] whitespace-nowrap">VỊ TRÍ CỦA BẠN</p>
    </div>
  );
}
...
function Icon24() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Icon">
          <path d={svgPaths.p625a980} id="Vector" stroke="var(--stroke-0, #EE3224)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p18c84c80} id="Vector_2" stroke="var(--stroke-0, #EE3224)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Text30() {
  return (
    <div className="flex-[408_0_0] h-[19.5px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[19.5px] left-0 not-italic text-[#080b0d] text-[13px] top-[-1px] whitespace-nowrap">123 Hai Bà Trưng, Quận 1, TP.HCM</p>
      </div>
    </div>
  );
}
...
function Container72() {
  return (
    <div className="h-[45.5px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.08)] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[17px] py-px relative size-full">
          <Icon24 />
...
function Container71() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] h-[72px] items-start left-[24px] top-[496px] w-[472px]" data-name="Container">
      <Paragraph63 />
      <Container72 />
    </div>
  );
...
function Paragraph64() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[16.5px] left-0 not-italic text-[#a4a4a4] text-[11px] top-0 whitespace-nowrap">Giá ước tính</p>
    </div>
  );
}
...
function Paragraph65() {
  return (
    <div className="h-[30px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['IBM_Plex_Mono:Bold',sans-serif] leading-[30px] left-0 not-italic text-[#ee3224] text-[20px] top-0 whitespace-nowrap">Từ 50.000đ</p>
    </div>
  );
}
...
function Container74() {
  return (
    <div className="h-[48.5px] relative shrink-0 w-[120px]" data-name="Container">
...
function Paragraph66() {
  return (
    <div className="h-[16.5px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="-translate-x-full absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[16.5px] left-[86px] not-italic text-[#a4a4a4] text-[11px] text-right top-0 whitespace-nowrap">Thời gian đến</p>
    </div>
  );
}
...
function Paragraph67() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="-translate-x-full absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[21px] left-[85.8px] not-italic text-[#080b0d] text-[14px] text-right top-[-1px] whitespace-nowrap">15-25 phút</p>
    </div>
  );
}
...
function Container75() {
  return (
    <div className="h-[39.5px] relative shrink-0 w-[85.805px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[2px] items-start relative size-full">
        <Paragraph66 />
        <Paragraph67 />
      </div>
...
function Container73() {
  return (
    <div className="absolute bg-[rgba(238,50,36,0.04)] content-stretch flex h-[76.5px] items-center justify-between left-[24px] px-[16px] rounded-[10px] top-[592px] w-[472px]" data-name="Container">
      <Container74 />
      <Container75 />
    </div>
  );
...
function Icon25() {
  return (
    <div className="absolute left-[270.08px] size-[16px] top-[17px]" data-name="Icon">
...
function Button6() {
  return (
    <div className="absolute bg-[#ee3224] h-[50px] left-[24px] rounded-[10px] top-[684.5px] w-[472px]" data-name="Button">
      <p className="-translate-x-1/2 absolute font-['IBM_Plex_Mono:Medium',sans-serif] leading-[21px] left-[224.41px] not-italic text-[14px] text-center text-white top-[13.5px] tracking-[1.12px] whitespace-nowrap">Tiếp tục</p>
      <Icon25 />
    </div>
  );
}
...
function Container51() {
  return (
    <div className="bg-white h-[758.5px] relative rounded-[16px] shrink-0 w-[520px]" data-name="Container">
...
export default function ServiceOverview() {
  return (
    <div className="bg-white relative size-full" data-name="service ( overview )">
      <Body />
      <Group1 />
